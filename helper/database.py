...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            suffix=None,
            metadata=False,
            metadata_code=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By :- @TN69Links" -metadata author="@TN69Links" -metadata:s:s title="Subtitled Telegram - @TN69Links" -metadata:s:a title="Telegram - @TN69Links" -metadata:s:v title="By:- @TN69Links" """
        )
